...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cwa/sign/">考勤管理列表</a></li>
		<shiro:hasPermission name="cwa:sign:edit"><li><a href="${ctx}/cwa/sign/form">考勤管理添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="sign" action="${ctx}/cwa/sign/" method="post" class="breadcrumb form-search">
