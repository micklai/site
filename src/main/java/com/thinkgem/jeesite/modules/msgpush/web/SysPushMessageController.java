 ...
 */
package com.thinkgem.jeesite.modules.msgpush.web;
...
import com.thinkgem.jeesite.modules.msgpush.service.SysPushMessageService;

/**
 * SysPushMessageController
 * @author lhc
 * @version 2017-08-22
 */
@Controller
@RequestMapping(value = "${adminPath}/msgpush/sysPushMessage")
public class SysPushMessageController extends BaseController {
	...
	@RequiresPermissions("msgpush:sysPushMessage:view")
	...
	public String list(SysPushMessage sysPushMessage, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/msgpush/sysPushMessageList";
	}
	...
	public String form(SysPushMessage sysPushMessage, Model model) {
		...
		return "modules/msgpush/sysPushMessageForm";
	}

	@RequiresPermissions("msgpush:sysPushMessage:edit")
	...
	public String save(SysPushMessage sysPushMessage, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/msgpush/sysPushMessage/?repage";
	}
