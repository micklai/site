...
import com.thinkgem.jeesite.modules.attendance.service.OrbitService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/attendance/orbit")
public class OrbitController extends BaseController {
	...
	@RequiresPermissions("attendance:orbit:view")
	...
	public String list(Orbit orbit, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/attendance/orbitList";
	}
	...
	public String form(Orbit orbit, Model model) {
		...
		return "modules/attendance/orbitForm";
	}

	@RequiresPermissions("attendance:orbit:edit")
	...
	public String save(Orbit orbit, Model model, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "保存记录轨迹成功成功");
		return "redirect:"+Global.getAdminPath()+"/attendance/orbit/?repage";
	}
	...
	public String delete(Orbit orbit, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "删除记录轨迹成功成功");
		return "redirect:"+Global.getAdminPath()+"/attendance/orbit/?repage";
	}
